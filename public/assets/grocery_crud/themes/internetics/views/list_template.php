<?php
    ...
    $this->set_css($this->default_theme_path.'/internetics/css/list.css');
    ...
    if ($this->config->environment == 'production') {
        ...
        $this->set_js_lib($this->default_javascript_path.'/' . $jquery_js);
        $this->set_js_lib($this->default_theme_path.'/internetics/js/jquery-plugins/jquery.form.js');
        $this->set_js_lib($this->default_theme_path.'/internetics/js/common/cache-library.js');
        $this->set_js_lib($this->default_theme_path.'/internetics/js/common/common.js');
        $this->set_js_lib($this->default_theme_path . '/internetics/js/bootstrap.min.js');
    }

    //section libs
    $this->set_js_lib($this->default_theme_path.'/internetics/js/jquery-plugins/gc-dropdown.min.js');
    $this->set_js_lib($this->default_theme_path.'/internetics/js/jquery-plugins/gc-modal.min.js');
    $this->set_js_lib($this->default_theme_path.'/internetics/js/jquery-plugins/bootstrap-growl.min.js');
    $this->set_js_lib($this->default_theme_path.'/internetics/js/jquery-plugins/jquery.print-this.js');


    //page js
    $this->set_js_lib($this->default_theme_path.'/internetics/js/datagrid/gcrud.datagrid.js');
    $this->set_js_lib($this->default_theme_path.'/internetics/js/datagrid/list.js');
                            ...
                            <?php if(!$unset_add){
							 ...
							 if (strpos($url,'/product/cards') !== false) {
								 ...
								 <div class="floatL t5">
									...
									{	?> 
                                    <a class="btn btn-default btn-outline-dark" href="<?php echo $add_url?>?pack=<?php echo $_GET["pack"]; ?>">
	                                 <?php }
