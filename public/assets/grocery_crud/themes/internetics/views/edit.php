<?php
    ...
    $this->set_css($this->default_theme_path.'/internetics/css/internetics.css?v=30');
    ...
    if ($this->config->environment == 'production') {
        ...
        $this->set_js_lib($this->default_theme_path . '/internetics/js/dropzone.js');
        ;
                ...
                <div class="row card_layout">
                 ...
                 <div class="row card_layout">
				 	...
				 	<div class="col-6 card_layout">
  					...
  					<?php foreach($fields as $field) { if ($field->field_name == 'related_pack') { echo $input_fields['related_pack']->input; }  } ?>
  					</div>
