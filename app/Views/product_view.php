  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item active">
        <a class="nav-link" href="/ffcweb/public/index.php/product">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
	    ...
	    if ($query->getNumRows()) {
        ?> <a class="nav-link" href="<?php echo site_url('product/user_settings/edit/'); echo $row->user_settings_id; ?>">Settings</a> <?php
    } else {
