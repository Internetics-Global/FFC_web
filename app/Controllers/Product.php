...
// $card_folder = '5';
	...
	if (strpos($post_array->data['question_image_1'], '_temp') !== false) {
		...
		$path_to_file = '../../ffcweb/upload/' . $user->id . '-'  .$user->user_folder . '/' . $card_folder . '/' . $path_parts['filename'];
...
function image_add_id($stateParameters) {
	...
	if (file_exists('../../ffcweb/upload/' . $user->id . '-'  .$user->user_folder . '/temp_card_folder')) {
    
    rename('../../ffcweb/upload/' . $user->id . '-'  .$user->user_folder . '/temp_card_folder','../../ffcweb/upload/' . $user->id . '-'  .$user->user_folder . '/' . $card_folder);
